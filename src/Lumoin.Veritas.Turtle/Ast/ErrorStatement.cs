...
/// <summary>
/// A top-level statement (a triple statement or a directive) the parser could not parse. Recovery emits
/// this in place of a well-formed <see cref="Statement"/>, spanning the tokens it skipped to resynchronise.
/// </summary>
/// <remarks>
...
/// <see cref="SkippedTokens"/> records the consumed tokens for refactoring tools that preserve trivia.
/// An error statement contributes nothing to the document's emitted quads.
/// </remarks>
[DebuggerDisplay("ErrorStatement {ExpectedProductionText,nq} ({SkippedTokens.Length} skipped) #{NodeId}")]
public sealed class ErrorStatement: Statement
{
    /// <summary>
    /// Initialises a new <see cref="ErrorStatement"/>.
    /// </summary>
